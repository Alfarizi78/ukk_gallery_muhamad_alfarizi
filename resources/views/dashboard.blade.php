            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6 mb-6 sm:mb-8">
                ...
                <div class="col-span-2 sm:col-span-1 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-4 sm:p-6 shadow-xl transform hover:scale-105 transition-all duration-300 relative overflow-hidden group">
                    ...
                    <div class="flex items-center justify-between relative z-10">
                        <div>
                            <p class="text-white text-xs sm:text-sm font-medium uppercase tracking-wider">Total Berita</p>
                ...
                <!-- Total Agenda -->
                <div class="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl p-6 shadow-xl transform hover:scale-105 transition-all duration-300 relative overflow-hidden group">
                    <div class="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 transition-opacity duration-300"></div>
                    ...
                    <div class="flex items-center justify-between relative z-10">
                        <div>
                            <p class="text-white text-sm font-medium uppercase tracking-wider">Total Agenda</p>
                            <p class="text-white text-4xl font-bold mt-2 group-hover:scale-110 transition-transform duration-300">
                                {{ $totalAgenda }}
                            </p>
                        </div>
                ...
                <!-- Total Albums -->
                <div class="bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl p-6 shadow-xl transform hover:scale-105 transition-all duration-300 relative overflow-hidden group">
                    <div class="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 transition-opacity duration-300"></div>
                    <div class="absolute -right-10 -bottom-10 w-40 h-40 bg-white rounded-full opacity-10 group-hover:scale-150 transition-transform duration-500"></div>
                    
                    <div class="flex items-center justify-between relative z-10">
                        <div>
                            <p class="text-white text-sm font-medium uppercase tracking-wider">Total Albums</p>
                            <p class="text-white text-4xl font-bold mt-2 group-hover:scale-110 transition-transform duration-300">
                                {{ $totalAlbums }}
                            </p>
                        </div>
                ...
                <!-- Total Kategori -->
                <div class="bg-gradient-to-br from-yellow-500 to-orange-600 rounded-2xl p-6 shadow-xl transform hover:scale-105 transition-all duration-300 relative overflow-hidden group">
                    <div class="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 transition-opacity duration-300"></div>
                    <div class="absolute -right-10 -bottom-10 w-40 h-40 bg-white rounded-full opacity-10 group-hover:scale-150 transition-transform duration-500"></div>
                    
                    <div class="flex items-center justify-between relative z-10">
                        <div>
                            <p class="text-white text-sm font-medium uppercase tracking-wider">Total Kategori</p>
                            <p class="text-white text-4xl font-bold mt-2 group-hover:scale-110 transition-transform duration-300">
                                {{ $totalKategori }}
                            </p>
                        </div>
                ...
                <!-- Total Events -->
                <div class="bg-gradient-to-br from-rose-500 to-pink-600 rounded-2xl p-6 shadow-xl transform hover:scale-105 transition-all duration-300 relative overflow-hidden group">
                    <div class="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 transition-opacity duration-300"></div>
                    <div class="absolute -right-10 -bottom-10 w-40 h-40 bg-white rounded-full opacity-10 group-hover:scale-150 transition-transform duration-500"></div>
                    
                    <div class="flex items-center justify-between relative z-10">
                        <div>
                            <p class="text-white text-sm font-medium uppercase tracking-wider">Total Events</p>
                            <p class="text-white text-4xl font-bold mt-2 group-hover:scale-110 transition-transform duration-300">
                                {{ $totalEvents }}
                            </p>
                        </div>
                ...
                <!-- Total Visitors -->
                <div class="bg-gradient-to-br from-gray-500 to-gray-600 rounded-2xl p-6 shadow-xl transform hover:scale-105 transition-all duration-300 relative overflow-hidden group">
                    <div class="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 transition-opacity duration-300"></div>
                    <div class="absolute -right-10 -bottom-10 w-40 h-40 bg-white rounded-full opacity-10 group-hover:scale-150 transition-transform duration-500"></div>
                    
                    <div class="flex items-center justify-between relative z-10">
                        <div>
                            <p class="text-white text-sm font-medium uppercase tracking-wider">Total Visitors</p>
                            <p class="text-white text-4xl font-bold mt-2 group-hover:scale-110 transition-transform duration-300">
                                {{ $totalVisitors }}
                            </p>
                        </div>
