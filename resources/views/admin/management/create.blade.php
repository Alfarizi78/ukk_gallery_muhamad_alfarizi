                    ...
                    <div class="flex items-center space-x-8 mb-8">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 dark:text-gray-400">
                                Silakan isi form di bawah ini untuk menambahkan admin baru
                            </p>
                        </div>
                    </div>
                    ...
                    <form method="POST" 
                        ...
                        <div class="flex flex-col sm:flex-row justify-end gap-3 pt-6">
                            ...
                            <button type="button"
                                    ...
                                    class="w-full sm:w-auto inline-flex justify-center items-center px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-lg hover:from-blue-600 hover:to-indigo-700 transition-all duration-200">
                                <svg class="w-5 h-5 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
