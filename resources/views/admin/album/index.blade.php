<x-app-layout>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div class="w-full sm:w-auto">
                <a href="{{ route('admin.album.create') }}" 
                   class="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg text-white transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-indigo-500/30">
    ...
    <script>
        ...
        function confirmDelete(albumId, albumName) {
            ...
            document.getElementById('deleteForm').action = `/admin/album/${albumId}`;
        }
